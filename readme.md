...
After running into various issues with memory while transforming the images to array with numpy, I decided to go with the Keras Image Generator, were the images were rescaled on the fly during training. 
